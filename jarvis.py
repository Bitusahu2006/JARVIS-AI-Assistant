...
def schedule():
    day = cal_day().lower()
    speak("My college  today's schedule is ")
    week={ 
    "monday": "my college, from 9:30 to 11:10 you have python lab, from 11:10  to you have modern physics class, from 12:00  to 12:50 la&DE have , from 12:50 to 1:35 you have a break, from 1:35 to 2:20 you have soft skill class from 2: onwards.",
    "tuesday": "my college, from 9:30 to 11:10 you have python lab, from 11:10  to you have modern physics class, from 12:00  to 12:50 la&DE have , from 12:50 to 1:35 you have a break, from 1:35 to 2:20 you have soft skill class from 2: onwards...",
    "wednesday": "college, today you have a full day of classes. From 9:00 to 10:50 you have Machine Learning class, from 11:00 to 11:50 you have Operating Systems class, from 12:00 to 12:50 you have Ethics in Technology class, from 1:00 to 2:00 you have a break, and today you have Software Engineering workshop from 2:00 onwards.",
    "thursday": "my college, from 9:30 to 11:10 you have python lab, from 11:10  to you have modern physics class, from 12:00  to 12:50 la&DE have , from 12:50 to 1:35 you have a break, from 1:35 to 2:20 you have soft skill class from 2: onwards.",
    "friday": "my college, today you have a full day of classes. From 9:30 to 10:20 you have Physics class, from 10:20 to 11:10 you have BEEE class, from 11:10 to 12:00 you have maths, from 1:00 to 2:00 you have a break, and today you have Capstone Project work from 2:00 onwards.",
    "saturday": "my college, today you have a more relaxed day. From 9:00 to 11:50 you have team meetings for your Capstone Project, from 12:00 to 12:50 you have Innovation and Entrepreneurship class, from 1:00 to 2:00 you have a break, and today you have extra time to work on personal development and coding practice from 2:00 onwards.",
    "sunday": "my college, today is a holiday, but keep an eye on upcoming deadlines and use this time to catch up on any reading or project work."
    } 
...
if __name__ == "__main__":
    ...
    while True:
        query=command().lower()
        #  query=input("input your command ->")
